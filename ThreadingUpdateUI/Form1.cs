...
namespace ThreadingUpdateUI
{
    public partial class Form1 : Form
    {
        ...
        private void btnGo_Click(object sender, EventArgs e)
        {
            ...
            //Can be run independently and while form is moving.
            //Go No Thread will still hijack it
        }
        ...
        private void btnGoNoThread_Click(object sender, EventArgs e)
        {
            ...
            for (int j=0; j<=i; j++)
            {
                ...
                lblCounter.Refresh();
                System.Threading.Thread.Sleep(sleep);
                //Sleep uses an input of milliseconds
            }
            ...
            return;
            //Return just makes it more explicit when the method returns void
        }
